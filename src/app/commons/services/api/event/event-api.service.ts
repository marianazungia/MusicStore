...
const URL_EVENT = environment.host + '/Concerts';
const URL_MNIMAL_DATA_NY_GENRE = environment.host + '/Concerts/GetMinimalByGenre';
const URL_GET_BY_GENRE = environment.host + '/Concerts/GetByGenre';
