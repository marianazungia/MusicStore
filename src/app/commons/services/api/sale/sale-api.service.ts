...
const URL_CREATE_SALE = environment.host + '/Sales/Post';
const URL_GET_SALE_BY_ID = environment.host + '/Sales/GetById';
const URL_GET_SALE_BY_USER = environment.host + '/Sales/GetByUser';
const URL_GET_COLLECTION = environment.host + '/Sales/GetCollection';
